...
function internal.getFunctionProxy(fun)
    ...
    if proxy == nil then
        obj = obj or mjrequire("castl/core_objects").obj
...
function internal.defaultValueString(o)
    ...
    throw = throw or mjrequire("castl/jssupport").throw
...
function internal.ToObject(v)
    ...
    if tv == "boolean" then
        Boolean = Boolean or mjrequire("castl/constructor/boolean")
        return new(Boolean, v)
    elseif tv == "number" then
        Number = Number or mjrequire("castl/constructor/number")
        return new(Number, v)
    elseif tv == "string" then
        String = String or mjrequire("castl/constructor/string")
        return new(String, v)
    end
...
function internal.setNewMetatable(o, prototype)
    ...
    if protoMt and protoMt.__tostring then
        ...
        objectToString = objectToString or mjrequire("castl/core_objects").objectToString
