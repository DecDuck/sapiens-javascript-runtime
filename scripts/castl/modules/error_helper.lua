...
local loadError = function()
    new = new or mjrequire("castl/core_objects").new
    Error = Error or mjrequire("castl/constructor/error/error")
end
local loadTypeError = function()
    new = new or mjrequire("castl/core_objects").new
    TypeError = TypeError or mjrequire("castl/constructor/error/type_error")
end
local loadSyntaxError = function()
    new = new or mjrequire("castl/core_objects").new
    SyntaxError = SyntaxError or mjrequire("castl/constructor/error/syntax_error")
end
local loadRangeError = function()
    new = new or mjrequire("castl/core_objects").new
    RangeError = RangeError or mjrequire("castl/constructor/error/range_error")
end
local loadReferenceError = function()
    new = new or mjrequire("castl/core_objects").new
    ReferenceError = ReferenceError or mjrequire("castl/constructor/error/reference_error")
end
local loadEvalError = function()
    new = new or mjrequire("castl/core_objects").new
    EvalError = EvalError or mjrequire("castl/constructor/error/eval_error")
end
local loadURIError = function()
    new = new or mjrequire("castl/core_objects").new
    URIError = URIError or mjrequire("castl/constructor/error/uri_error")
end
